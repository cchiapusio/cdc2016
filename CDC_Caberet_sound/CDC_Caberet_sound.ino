...
#define LED_TYPE NEOPIXEL                                       // What kind of strip are you using (WS2801, WS2812B or APA102)?
#define NUM_LEDS 220  // Number of LED's.
#define TRIGGERLVL 50
...
void soundbracelet() {
  ...
  Serial.println(lvl);
  if (lvl>TRIGGERLVL) {
    fill_solid(leds, NUM_LEDS, 0xFFED47);
  }
